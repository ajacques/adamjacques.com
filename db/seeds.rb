...
job1 = Job.create(active: 1, start_date: Date.new(2009, 1, 20), end_date: nil, position: 'President', department: 'The Executive Branch', organization: org1, manager: manager1, location: city)
